...
('Admin', '$argon2id$v=19$m=65536,t=3,p=4$fo+x1vrfm3MuRQhhLEXIOQ$VNIE4yr5NbZMNKtaHEKs127XFJaUeZHhEtJzjk7znS8', 'jnauro1@students.towson.edu', 2, 1, 'N'),
('John', 'abc123', 'etaylor5@students.towson.edu', 2, 2, 'N'),
('James1', '$argon2id$v=19$m=65536,t=3,p=4$L0XoHWOMEWKM0ZpTCuG8lw$QhURmet+qkSHU4Eq3K6gTivTb3x8ln36888iuzEgUNc', 'naurotj@gmail.com1', 1, 6, 'N'),
...
('newuser', '$argon2id$v=19$m=65536,t=3,p=4$oZSS0rrXWus9ByAkZIxRCg$QLwrV9wNTBkUHwaPsp8tdEHV5AS7Voxrey18SL3ssvQ', 'naurotmunchkin@gmail.com', 1, 26, 'N');
